...
define(["serviceModule"], function (services) {
    ...
    services.service("statsService", function ($http, ajaxService, Current) {
        ...
        this.getQuarterlySiteNetworks = function (success, error) {
            ajaxService.post(base_url + '/stats/getQuarterlySiteNetworks', success, error)
        }
        ...
        this.getHotApUniqueClientThreshold = function (param, success, error) {
            ajaxService.post(base_url + '/stats/getHotApUniqueClientThreshold', param, success, error)
        };

        this.getHotApTrafficThreshold = function (param, success, error) {
            ajaxService.post(base_url + '/stats/getHotApTrafficThreshold', param, success, error)
        };
