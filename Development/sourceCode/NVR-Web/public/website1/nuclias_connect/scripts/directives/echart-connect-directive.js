 ...
 */
define(['app', 'echarts', 'scripts/directives/theme'], function (app, echarts, barChart) {

    app.register.directive('connectChart', ['$http', 'scripts/directives/theme', function ($http, theme) {
                return {
                    restrict: 'EA',
